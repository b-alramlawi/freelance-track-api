...
async function updateProfile(req, res) {
    try {
        ...
        upload(req, res, async (err) => {
            ...
            await User.findByIdAndUpdate(userId, {profile_picture: newFileName, updated_at: new Date()});
...
async function updateUser(req, res) {
    try {
        ...
        // Update the user's information including the 'updated_at' field
        updatedUserData.updated_at = new Date();
